...
class CNNLSTM(nn.Module):
    def __init__(self, first_conv, num_conv, max_pool, num_bins, hidden_dim, dropout, num_lstm, num_classes):
        super().__init__()
        ...
        lstm_in = conv_out * conv_freq
        self.lstm = nn.LSTM(input_size=lstm_in, hidden_size=hidden_dim, num_layers=num_lstm, batch_first=True, dropout=dropout, bidirectional=True)
